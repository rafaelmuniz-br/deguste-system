...
insert into public.produtos (id, categoria_id, nome, descricao, preco_centavos, eh_combo, ordem) values
  ('00000000-0000-4000-8001-000000000001', '00000000-0000-4000-8000-000000000002',
    'Smash Exemplo', 'Produto de exemplo para desenvolvimento.', 2199, false, 1),
  ('00000000-0000-4000-8001-000000000002', '00000000-0000-4000-8000-000000000003',
    'Burguer Exemplo', 'Produto de exemplo para desenvolvimento.', 3399, false, 1),
  ('00000000-0000-4000-8001-000000000003', '00000000-0000-4000-8000-000000000004',
    'Refrigerante Exemplo', 'Lata 350ml.', 700, false, 1),
  ('00000000-0000-4000-8001-000000000004', '00000000-0000-4000-8000-000000000001',
    'Combo Exemplo', 'Escolha um hambúrguer + refrigerante.', 3999, true, 1);
