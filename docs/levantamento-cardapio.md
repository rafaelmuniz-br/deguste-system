...
| --- | --- | --- | --- |
| Combo Brownie Grátis | 47,97 (de 60,96, -21%) | 1 hambúrguer + 1 entrada + 1 bebida + 1 sobremesa (brownie) | Hambúrguer: 1 opção obrigatória entre os 5 smashs e os 7 burguers 180g nomeados (os sabores mais caros cobram diferença, de + 1,00 até + 17,00). Entrada: 1 das 4 opções (as maiores cobram diferença, até + 16,00). Bebida: 1 das 6 opções, sem custo extra. Sobremesa: Brownie de Ninho, fixo e sem custo extra. |
| Combo Brownie+Bebida Grátis | 62,97 (de 83,95, -25%) | 2 hambúrgueres + 1 entrada + 1 bebida grátis + 1 brownie grátis | Não conferi o modal em detalhe — pelo padrão do combo acima, deve deixar escolher 2 hambúrgueres entre smashs/burguers, 1 entrada e 1 bebida, com brownie fixo. Confirmar antes de carregar no banco. |
| Combo 3 Smashs 90g | 58,63 (de 68,97, -15%) | 3 Smashs 90g | Escolha 3 opções entre os 5 smashs nomeados (Jackfino, Laurinha, Bolado, Xeque Mate, Degorgson); os sabores mais caros cobram diferença (de + 1,00 até + 4,00 cada). O "monte o seu" não entra como opção do combo. |
| Combo 4 Smashs 90g | 78,17 (de 91,96, -15%) | 4 Smashs 90g | Não conferi o modal, mas deve seguir a mesma lógica do combo de 3 (escolher 4 entre os 5 smashs nomeados). Confirmar antes de carregar no banco. |
| Combo do Jackfino | 43,32 (de 50,97, -15%) | 1 Smash Jackfino (fixo) + 1 entrada + 1 bebida | Hambúrguer é fixo (Jackfino, não dá pra trocar). Entrada: 1 das 4 opções (a Batata Trips cobra + 16,00). Bebida: 1 das 6 opções, sem custo extra. |
| Combo do Boladão | 56,00 (de 65,97, -15%) | 1 Burguer Boladão (fixo) + 1 entrada + 1 bebida | Não conferi o modal, mas pelo nome/descrição deve seguir o mesmo padrão do Combo do Jackfino (hambúrguer fixo + escolha de entrada e bebida). Confirmar antes de carregar no banco. |
